...
// contract BridgeManagerCCIP_MockUp is Ownable, CCIPReceiver {
...
//         //     data: abi.encode(_amount, CHAIN_ID, _chainIdTo, nonce, msg.sender, _signature),
...
//         // bytes32 messageId = i_ccipRouter.ccipSend(destination.chainSelector, message);

//         // emit MessageSent(msg.sender, _amount, CHAIN_ID, _chainIdTo, _feeToken, fees, messageId);
//     }
